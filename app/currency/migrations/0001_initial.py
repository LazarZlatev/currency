# Generated by Django 4.2.7 on 2024-01-11 13:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('request_time', models.DecimalField(decimal_places=14, max_digits=19, verbose_name='Time')),
            ],
        ),
        migrations.CreateModel(
            name='Source',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='Created')),
                ('currency_type', models.SmallIntegerField(choices=[(1, 'Dollar'), (2, 'Euro')], default=1, verbose_name='Currency type')),
                ('currency_type_mono', models.SmallIntegerField(choices=[(840, 'Dollar'), (980, 'Euro')], default=840, verbose_name='Currency type')),
